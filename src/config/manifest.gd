...
var _metadata := {
    ...
    app_name = "Ludum Dare 49",
    app_id = "dev.levi.ludum_dare_49",
    app_version = "0.0.1",
    score_version = "0.0.1",
...
var _images_overrides := {
    ...
    developer_splash = \
            preload("res://assets/images/logos/levi_logo_splash.png"),
...
var _surfacer_manifest := {
    ...
    default_tile_set = preload("res://src/levels/collidable_tile_set.tres"),
